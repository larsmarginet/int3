          ...
          <header class="webshop__header">
            <nav class="webshop__secondary-nav">
              ...
              <ul class="webshop__secondary-nav__list">
                ...
                <li class="webshop__secondary-nav__list__item">
                  <a class="webshop__secondary-nav__list__item__link webshop__secondary-nav__list__item__link--bold" href="index.php">
                ...
                <li class="webshop__secondary-nav__list__item"><a class="webshop__secondary-nav__list__item__link webshop__secondary-nav__list__item__link--bold" href="index.php">
            ...
            <nav class="webshop__primary-nav">
              <ul class="webshop__primary-nav__list">
                ...
                <li class="webshop__primary-nav__list__item"><a class="webshop__primary-nav__list__item__link" href="index.php">
